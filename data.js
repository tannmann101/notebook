/* Sample contents.
   ...
   Entry numbers are one sequence across the whole notebook — the next entry
   anywhere takes the next number, whatever it's filed in.
  ...
  window.NOTEBOOK_DATA = {
    ...
    notebooks: [
      ...
      },
      {
        ...
        entries: [
          { n: 61, passages: [ p(0, "Borrow the moisture meter back from Dad.") ] },
          { n: 59, passages: [ p(2, "Dovetail marker — 1:6 for hardwood, 1:8 for soft. I look this up every single time.") ] },
          { n: 56, passages: [ p(5, "Call about the chimney liner before it gets cold enough to matter.") ] },
          { n: 52, passages: [ p(8, "3/8 blade for curves, 1/2 for resawing. Write it on the saw.") ] }
        ]
      },
      {
